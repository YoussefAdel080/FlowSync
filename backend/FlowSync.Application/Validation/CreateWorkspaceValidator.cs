...
namespace FlowSync.Application.Validation
{
    public class CreateWorkspaceValidator: AbstractValidator<CreateWorkspaceRequest>
    {
        ...
        public CreateWorkspaceValidator(IWorkspaceRepository workspaceRepository, ICurrentUserService currentUserService) {
            ...
            RuleFor(x => x.Name)
                ...
                .WithMessage("You already own a workspace with this name.");
        }
    }
}
